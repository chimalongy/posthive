...
import { Check, Link2, Unlink, Globe, Camera, Play, Music2, MessageSquare, RefreshCw, HelpCircle } from 'lucide-react';
...
export default function PlatformCard({ platform, connected, details, onConnect, onDisconnect, onReconnect, onShowGuide }) {
        ...
        {connected ? (
          <div className="flex flex-col gap-2 w-full">
            ...
            <div className="flex items-center gap-2 w-full">
              ...
              {(platform === 'youtube' || platform === 'tiktok' || platform === 'twitter' || platform === 'facebook') && (
                <button
                  onClick={onReconnect}
          ...
          <div className="flex flex-col gap-2 w-full">
            ...
            <button
              onClick={onShowGuide}
              className="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-xs font-medium text-zinc-500 dark:text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors"
            >
